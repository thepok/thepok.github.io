...
try{
 ...
 await page.evaluate(()=>__loadBearing.simulation.pause(true));await page.screenshot({path:'artifacts/public/collapse.png'});await page.setViewportSize({width:390,height:844});await page.click('#kinetic-benchmark');await page.screenshot({path:'artifacts/public/mobile.png'});
