...
struct Body {
 ...
 int active=1,canSleep=1,ccd=0;V beforeV;
};
...
struct Contact {int a,b;V p,n,t1,t2,ra,rb;float depth=0,nmass=0,t1mass=0,t2mass=0,normal=0,f1=0,f2=0,target=0,friction=0;u64 key=0;};
...
static void updateBody(int id){Body &b=bodies[id];Shape &s=shapes[b.shape];b.invI=b.invMass>0?rotated(b.localInvI,b.q):diag(0,0,0);b.worldI=rotated(b.localI,b.q);V origin=b.p-rot(b.q,s.center);float *o=b.out;o[0]=origin.x;o[1]=origin.y;o[2]=origin.z;o[3]=b.q.x;o[4]=b.q.y;o[5]=b.q.z;o[6]=b.q.w;o[7]=b.v.x;o[8]=b.v.y;o[9]=b.v.z;o[10]=b.w.x;o[11]=b.w.y;o[12]=b.w.z;o[19]=b.p.x;o[20]=b.p.y;o[21]=b.p.z;o[22]=b.active&&b.motion!=0&&b.added;o[23]=b.motion;o[24]=b.mass;o[25]=b.canSleep;o[26]=b.added;
}
