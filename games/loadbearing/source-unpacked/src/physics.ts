...
export class Simulation {
 ...
 constructor(J:any, public pieces:Piece[], public scenario:Scenario, public intensity=1, rules:SimulationRules = {}, workerThreads=0) {
  ...
  // 8/2 keeps a 60 Hz integration step and continuous impact sweeps, but trims solver
  // iterations that are visually redundant at this scale. Medium/small structures keep
  // their existing higher-precision settings.
  ps.mNumVelocitySteps=large?8:medium?16:48;ps.mNumPositionSteps=large?2:medium?4:12;this.system.SetPhysicsSettings(ps);
