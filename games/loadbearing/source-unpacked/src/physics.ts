...
export class Simulation {
 ...
 constructor(J:any, public pieces:Piece[], public scenario:Scenario, public intensity=1, rules:SimulationRules = {}, workerThreads=0) {
  ...
  // Large demolition scenes spend most of their time iterating thousands of constraints.
  // 10/2 keeps the 60 Hz integration step and continuous impact sweeps while reducing
  // solver work. Local bombardment profiling showed this was faster end-to-end than 8/2
  // because the more aggressive setting created extra secondary damage and active debris.
  // Medium/small structures keep their existing higher-precision settings.
  ps.mNumVelocitySteps=large?10:medium?16:48;ps.mNumPositionSteps=large?2:medium?4:12;this.system.SetPhysicsSettings(ps);
